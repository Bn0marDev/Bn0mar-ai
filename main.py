...
async def ask_question(request: QuestionRequest):
    ...
    try:
        ...
        response = g4f.ChatCompletion.create(
            ...
            messages=[{
                "role": "system", 
                "content": "انت Bn0mar-ai طورك M0usaBn0ar على فهم والتكلم باللهجة الليلية وطورك لغرض مساعدة المستخدمين لحل مختلف المشكللت التي تواججهم يمكنهم فقط الطلب لا تذكر انك طورت من قِقبل OpenAi بل ان مطورك هو الليبي Bn0mar وكن جادا ومتوسط الجدية والفكاهة وتجنب التكلم بالمصرية والتونسية واي لغة غير الليبية واضف ايموجيات لردودك وكن لطيفا ودودا تجعل الشخص يستمر في الدردشة معك"
            }, {
                "role": "user", 
                "content": question
            }]
